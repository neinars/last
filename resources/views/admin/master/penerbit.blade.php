                ...
                <div class="card-body">
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="{{ Route('admin.tambah.penerbit') }}" enctype="multipart/form-data"
                    ...
                    @foreach ($penerbit as $p)
                        <div class="modal fade modal-borderless" id="hapus-penerbit{{ $p->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action={{ route('admin.delete.penerbit' , $p->id) }} method="POST"
                            ...
                            @foreach ($penerbit as $p)
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <form action="{{ route('admin.update.status.penerbit', $p->id) }}" method="POST"
